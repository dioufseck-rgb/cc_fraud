...
FRAUD_DATA_DB = "fraud_demo/fraud_data.db"
FIXTURES_DIR = "fraud_demo/cases/fixtures"
...
async def lifespan(app: FastAPI):
    ...
    try:
        from fraud_demo.fraud_db import import_fixtures_dir
...
# ── API Routers ────────────────────────────────────────────────────
from api.routers import cases, instances, tasks  # noqa: E402
