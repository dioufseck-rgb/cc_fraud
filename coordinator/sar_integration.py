...
Usage:
    from coordinator.evidence import CaseEvidenceStore
    from coordinator.sar_integration import build_case_input, capture_workflow_outputs
...
if TYPE_CHECKING:
    from coordinator.evidence import CaseEvidenceStore
    from coordinator.types import InstanceState
